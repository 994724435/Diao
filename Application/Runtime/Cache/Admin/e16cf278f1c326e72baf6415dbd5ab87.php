...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">文章管理</a><a href="<?php echo U('/index.php/Admin/Article/index');?>" class="home_pass">文章列表</a><a class="home_now">文章编辑</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="<?php echo U('/index.php/Admin/Article/add');?>" method='post'  enctype="multipart/form-data">
