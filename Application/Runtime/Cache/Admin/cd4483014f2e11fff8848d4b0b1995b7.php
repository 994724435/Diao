...
<div class="rightfix">
    <a href="<?php echo U('/Admin/Index/index');?>" class="home1"></a><a class="home_pass">作品管理</a><a class="home_now">作品列表</a>
    <div class="clear"></div>
        ...
        <form action="<?php echo U('Admin/Article/formDelete');?>" style="margin:20px 20px;" method="post">
          <table> 
            <tr class="table_title"> 
              ...
              <td class="table3">时间</td> 
            </tr> 
            <div class="clear"></div> 
            <?php if(is_array($data)): foreach($data as $key=>$value): ?><tr class="table_list"> 
                <td class="table1"><input type="checkbox" value="<?php echo ($value['art_id']); ?>" name="idarr[]"/></td> 
                <td class="table4"><?php echo ($value["p_title"]); ?></td> 
                <td div class="table2"> 
                    <a href="/index.php/Admin/Member/edit/id/<?php echo ($value['p_id']); ?>" class="aa2">编辑</a> / 
                    <a href="/index.php/Admin/Member/delete/id/<?php echo ($value['p_id']); ?>" class="aa3">删除</a>
                </td> 
                <td class="table3"><?php echo ($value["p_addtime"]); ?></td> 
              </tr> 
              <div class="clear">
            </div><?php endforeach; endif; ?> 
        </table> 
