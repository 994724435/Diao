...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">案例管理</a><a href="<?php echo U('/index.php/Admin/Member/index');?>" class="home_pass">案例列表</a><a class="home_now">作品添加</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post'  enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">名 称</div><div class="col_right f"><input type="text" name="title" class="title_text" value="<?php echo ($data['p_title']); ?>"/></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章分类 -->
        <div class="choose_sort same_height"> <div class="col_left f">选择分类</div> <div class="col_right f"> 
        	<select class="sort f" name="cate" id="cate"> 
        		<option value="<?php echo ($Mname['m_id']); ?>" selected="selected"><?php echo ($Mname['m_name']); ?></option> 
	        	<?php if(is_array($Mdata)): foreach($Mdata as $key=>$value): ?><option value="<?php echo ($value["m_id"]); ?>"><?php echo ($value["m_name"]); ?></option><?php endforeach; endif; ?> 
        	</select> <select class="sort f" name="scate" id="scate" style="margin-left:25px;">
        	<option value=""></option> </select> 
        	<div class="f"></div> <div class="clear"></div> </div> </div> <div class="clear"></div>
        <!-- 文章缩略图 -->
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f"> <img id="imghead" src='<?php echo ($data['p_thumb']); ?>'> </div> <div class="add_img_c"> <div class="fileimg"><input type="file" onchange="previewImage(this)" name="thumb"/></div> </div> </div> </div> <div class="clear"></div>
        <!-- 文章提交者 -->
        <div class="submit_person same_height"><div class="col_left f">提交人</div><div class="col_right f"><input type="text" name="author" class="title_text" value="<?php echo ($data['p_author']); ?>" /></div><div class="clear"></div></div> <div class="clear"></div>
         <!-- 文章发布日期 -->
        <!-- 文章来源 -->
        <div class="source same_height"><div class="col_left f">来源</div><div class="col_right f"><input type="text" class="title_text" name="source" value="<?php echo ($data['p_source']); ?>" /></div><div class="clear"></div></div> <div class="clear"></div>
        <!-- 文章访问权限 -->
        <!-- 文章摘要 -->
        <!-- 文章详情 -->
        <div class="article_detail"><div class="col_left f d_bottom">文章详情</div><div class="col_right f d_bottom"><div class="detail_edit"> <?php echo $htmlData; ?> <textarea name="content1" class="textarea"><?php echo ($data['p_content']); ?></textarea> </div></div></div> 
        <div class="clear"></div>
        <!-- 提交或者取消 -->
