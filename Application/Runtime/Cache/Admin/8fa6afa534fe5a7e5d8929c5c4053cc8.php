...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_pass"></a><a class="home_now">名师简介</a>

  	<div class="clear"></div>
  	 <p style="margin:10px 0 0 50px;color: red;">
  	 	提示：为前台美观，首页名师简介的每一行对应每一个内容（18字内） 标签1、2、3是前台轮播图三行
  	...
  	<table CellSpacing=0>
  		<div class="table_title">
  			<tr style="text-align: center;">
	  			...
	  			<td ><b>标签1</td>
	  			<td ><b>标签2</td>
	  			<td class="tab2"><b>标签3</td>			
	  			<td ><b>操作</b></td>
  			</tr>
  		</div>
 		<div class="clear"></div>
 		
 		<?php if(is_array($data)): foreach($data as $key=>$val): ?><form method="post" action="">
	  		<tr style="text-align: center;">
	  			<td ><input type="text" name="title" id="" value="<?php echo ($val["i_title"]); ?>" style="width: 50px;"/></td>
	  			<td ><textarea name="job" rows="3" cols="10"><?php echo ($val["i_job"]); ?></textarea></td>
	  			<td ><textarea name="content"   rows="5" cols="19"><?php echo ($val["i_content"]); ?></textarea></td>
	  			<td ><textarea name="content0"   rows="5" cols="19"><?php echo ($val["i_content1"]); ?></textarea></td>
	  			<td ><textarea name="content2"   rows="5" cols="19"><?php echo ($val["i_content2"]); ?></textarea></td>
	  			<td class="tab2"><textarea name="content3"   rows="5" cols="19"><?php echo ($val["i_content3"]); ?></textarea></td>
	  			<td ><a class="see"><input type="submit" value="修改" name="" /></a>
	  				<input type="hidden" name="id" id="" value="<?php echo ($val["i_id"]); ?>" />
	  			<a class="see" href="/index.php/Admin/Member/picload/id/<?php echo ($val["i_id"]); ?>"><input type="button" value="图片上传" name="" /></a>	
	  			</td>
	  		</tr>
