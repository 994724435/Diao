...
<style>
	...
	.keep button{
		...
		margin-left: 20px;
		padding-top: 14px;
		background: url(/Public/Admin/images/vipkeep.png);
	}
	.addimg{
		margin-left: 668px;
		padding-top: 29px;
	...
	.banneradd{
		...
		height: 35px;
		margin-bottom: 219px;
		background: url(/Public/Admin/images/vipadd.png);
	}
	.banneraddtab{
		float: left;
		margin-top: 37px;
	...
	.fileimg{
		...
		width: 119px;
		height: 35px;
		background: url(/Public/Admin/images/fileimg.png) no-repeat center;
	}
	.fileimg input{
		width: 100%;
		height: 100%;
	...
	#imghead {filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=image);width:254px;height:64px;margin-top: 0;}
</style>
<div class="rightfix">
  	<a class="home1" href="/Admin/Index/index"></a><a class="home_pass">友情链接</a><a class="home_pass" href="/Admin/Link/words">文字链接</a><a class="home_now">添加文字链接</a>
  	<div class="clear"></div>
				...
				<div class='check_page'>
	  			...
	  			<table class="banneraddtab">
	  				<tr>
	  					...
	  					<td><input type="text" class="text" name="wl_name"></td>
	  				</tr>
	  				<tr>
	  					<td class="tabtit">排序：</td>
	  					<td><input type="text" class="text" name="wl_order"></td>
	  				</tr>
	  				<tr>
	  					<td class="tabtit">链接：</td>
	  					<td><input type="text" class="text" name="wl_gourl"></td>
	  				</tr>
	  				<tr>
	  					<td></td>
