...
<?php if(is_array($n_nav)): foreach($n_nav as $key=>$val): ?><div>
  ...
  <!--文章编辑-->
  <div class="rightfix">
    <a class="home1"></a><a class="home_pass">网站设置</a><a class="home_now">基础设置</a>
    <div class="clear"></div>
    <div class="article_list">
      <div class="hint">
        <p>添加关键字让搜索引擎更快找到您的网站</p>  
      </div>
      <div class="seo_table1">
        <p>网站关键字:</p>
        <input type="text" placeholder="请在此输入您的网站关键字">
      </div>
      <div class="seo_table2">
        <p>网站关键字:</p>
        <textarea name="" id="" cols="30" rows="10" placeholder="请在此输入您的网站描述"></textarea>
      </div>
      <input type="submit" value="立即保存" class="seo_submit">
    </div>
