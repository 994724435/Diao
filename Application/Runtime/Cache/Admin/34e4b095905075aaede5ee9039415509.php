...
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">专业管理</a><a class="home_now">班级列表</a>
  <div class="clear"></div>
    ...
    <div class="title">
      ...
      <div id="dd" class="wrapper-dropdown-3" tabindex="1">
        <span style="color:#e2e1e1;">
           <?php if($cid != 0): echo ($cate["cate_name"]); else: ?>未分类<?php endif; ?></span>
      	<ul class="dropdown">
         <!-- <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Product/index');?>'">未分类</a></li>-->
          <?php if(is_array($acate)): foreach($acate as $key=>$val): ?><li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Product/index',array('cid'=>$val['cate_id']));?>'"><?php echo ($val["cate_name"]); ?></a></li><?php endforeach; endif; ?>
      	</ul>
      </div>
      <div id="aa" class="wrapper-dropdown-3" tabindex="1">
        ...
        <?php if($cid != 0): ?><ul class="dropdown">
            <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Product/index',array('cid'=>$cate['cate_id']));?>'">未分类</a></li>
            <?php if(is_array($scate)): foreach($scate as $key=>$val): ?><li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Product/index',array('cid'=>$cate['cate_id'],'sid'=>$val['cate_id']));?>'"><?php echo ($val["cate_name"]); ?></a></li><?php endforeach; endif; ?>
          </ul>
        <?php else: ?>
          <ul class="dropdown">
            <li><a onclick="javascript:window.location.href='<?php echo U('/index.php/Admin/Product/index',array('cid'=>$cate['cate_id']));?>'">未分类</a></li>
      ...
      <form class="allen" action="<?php echo U('/index.php/Admin/Product/index');?>"> 
          <button type="submit"><span class="glyphicon glyphicon-search"></span></button>
          <input type="text" value="" class="search" placeholder="输入关键字搜索" name="q" id="searchBox" >
      </form>
      <div class="clear"></div>
    </div>
    <form action="<?php echo U('/index.php/Admin/Product/formDelete');?>" style="margin:20px 20px;" method="post">
      <table>
        ...
        <div class="clear"></div>
        <?php if(is_array($result)): foreach($result as $key=>$value): ?><tr class="table_list">
          <!--<td class="table1"><input type="checkbox" value="<?php echo ($value['pro_id']); ?>" name="idarr[]"/></td>-->
          <td class="table1"> <p style="text-align: center;padding-top: 15px;">班级名称：</p></td>
         <td class="table4"> <?php echo ($value["pro_name"]); ?></td>
          <td div class="table2">
              <a href='/index.php/Admin/Product/editor/id/<?php echo ($value["pro_id"]); ?>' class="aa2">编辑</a> / 
              <a href="/index.php/Admin/Product/delete/id/<?php echo ($value["pro_id"]); ?>" class="aa3">删除</a></td>
