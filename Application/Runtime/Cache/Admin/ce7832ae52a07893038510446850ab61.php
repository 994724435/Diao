...
<!--添加文章-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">图片管理</a><a class="home_now">添加图片</a>
  <div class="clear"></div>
  <div style="width:1072px;margin-left:5px;">
    <form action="" method='post'  enctype="multipart/form-data">
      <div class="article_edit_list">
        <!-- 标题 -->
        <div class="edit_title"><div class="col_left f">老师名称</div>
        <div class="col_right f"><?php echo ($result['i_title']); ?></div>
        <div class="clear"></div></div> 
        <div class="clear"></div>
        <div class="thumbnail"> <div class="col_left f">缩略图</div> <div class="col_right f"> <div class="img_containner f">
        			<img id="imghead" src='<?php echo ($result['i_thumb']); ?>'> </div> <div class="add_img_c"> <div class="fileimg">
        				<input type="file" onchange="previewImage(this)" name="thumb"/></div> 
