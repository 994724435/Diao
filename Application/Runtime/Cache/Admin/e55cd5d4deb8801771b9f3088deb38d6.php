...
<div class="rightfix">
  	...
  	<table CellSpacing=0>
 		...
 		<?php if(is_array($data)): foreach($data as $key=>$val): ?><tr>
	  			<td class="tab1"><input type="text" name="title" id="" value="<?php echo ($val["i_title"]); ?>" /></td>
	  			<td class="tab2"><textarea name="content"   rows="6" cols="100"><?php echo ($val["i_content"]); ?></textarea></td>
	  			<td><input type="hidden" name="id" id="" value="<?php echo ($val["i_id"]); ?>" /></td>
	  			<td class="tab5"><a class="see"><input type="submit" value="提交" name="" /></a><a class="close" style="display:none">关闭</a></td>
	  		</tr>
