...
<!--文章添加-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">专业管理</a><a href="<?php echo U('/index.php/Admin/Product/index');?>" class="home_pass">专业列表</a><a class="home_now">专业分类</a>
  <div class="clear"></div>
	  <div class="article_type_containners">
		  <form action="<?php echo U('/index.php/Admin/Product/cateDelete');?>" method="post">
		  	<div class="article_type">
		  		...
		  		<?php if(is_array($cate)): foreach($cate as $key=>$val): ?><div class="article_conn">
				  		<div class="aticle_content">
				  			...
				  			<div class="content_col4 f"><p class="operation"><span class="hid">显示</span>/<span class="edit">编辑</span>/<a href="<?php echo U('/index.php/Admin/Product/classDel',array('cate_id'=>$val['cate_id']));?>">删除</a></p></div>
				  			<div class="clear"></div>
				  		</div>
				  		...
				  		<div class="aticle_zi_container">
					  		<?php if($val["sid"] != false): if(is_array($val["sid"])): foreach($val["sid"] as $key=>$v): ?><div class="aticle_content_zi1">
					  				...
					  				<div class="content_col4 f"><p class="operation"><span class="edit">编辑</span>/<a class="delet" href="<?php echo U('/index.php/Admin/Product/classDel',array('cate_id'=>$v['cate_id']));?>">删除</a></p></div>
					  				<div class="clear"></div>	
...
<script type="text/javascript">
    ...
    if(adm_power.indexOf('产品分类') === -1){
		...
		setTimeout(function(){
			...
			$.post('/index.php/Admin/Product/fir_order',{'order':order},function(data){
				if(data.cateOrder){
					return true;
				}
			},'json')
	...
	$('.second_edit_text,.edit_text').blur(function(){
		...
		console.log(cate);
		$.post('/index.php/Admin/Product/classification',{'class':sec_class,'cate':cate},function(data){
			if(data.res){
				return true;
			}
		},'json')
