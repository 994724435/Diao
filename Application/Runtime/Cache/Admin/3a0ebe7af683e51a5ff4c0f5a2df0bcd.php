...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_pass"></a><a class="home_now">总体简介</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
 		...
 		<div class="clear"></div>
 		<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr>
	  			<td class="tab1"><?php echo ($val["msg_name"]); ?></td>
	  			<td class="tab2"><a class="look"><?php echo ($val["msg_ctitle"]); ?></a><a class="shut"><?php echo ($val["msg_ctitle"]); ?></a></td>
	  			<td class="tab3"><?php echo ($val["msg_tel"]); ?></td>
	  			<td class="tab4"><?php echo (date("Y-m-d H:m",$val["msg_addtime"])); ?></td>
	  			<td class="tab5"><a href="<?php echo U('/Admin/Message/delete',array('msg_id'=>$val['msg_id']));?>" class="delete">删除</a> / <a class="see">查看</a><a class="close" style="display:none">关闭</a></td>
	  		</tr>
	  		<tr>
	  			<td colspan="5" class="tab6">
	  				<div class="off">
	  					<h3>留言详情：</h3><span><?php echo ($val["msg_content"]); ?></span><span class="time"><?php echo (date("Y-m-d H:m",$val["msg_addtime"])); ?></span>
	  				</div>
	  			</td>
