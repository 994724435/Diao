	...
	<body>
		...
		<div class="center-block">
			<div class="location">
				...
				<span>&gt;</span>
				<a href="/index.php/Home/News/news/id/2">动态资讯</a>
				<span>&gt;</span>
			...
			<div class="detail">
				...
				<p class="other">
					<span>来源: <?php echo ($data['art_from']); ?></span>
					<span>作者: <?php echo ($data['art_author']); ?></span>
					<span>发布时间: <?php echo ($data['art_addtime']); ?></span>
					<span><span><?php echo ($data['art_visit']); ?></span>次浏览</span>
				</p>
				<div class="line"></div>
				<div class="pic"><img class="adapt" src="<?php echo ($data['art_thumb']); ?>"/></div>
				<p class="content"><?php echo ($data['art_content']); ?></p>
				<div class="links">
				...
				<div class="change_artical">
					<a href="/index.php/Home/News/detail/id/<?php echo ($data1['art_id']); ?>"><span class="prev">上一篇：</span><span class="artical_name"><?php echo ($data1['art_title']); ?></span></a>
					<a href="/index.php/Home/News/detail/id/<?php echo ($data2['art_id']); ?>"><span class="next">下一篇：</span><span class="artical_name"><?php echo ($data2['art_title']); ?></span></a>
				</div>
			</div>
		</div>
				<div class="footer">
