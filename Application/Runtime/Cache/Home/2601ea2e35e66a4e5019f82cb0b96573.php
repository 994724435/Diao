			...
			<div class="login_box">
				<div class="box">
					...
					<form action="" method="post">
						<input type="text" name="username" id="username" value="" autocomplete="off" placeholder="请输入您的用户名" />
						<input type="password" name="password" id="password" autocomplete="off" value="" placeholder="请输入您的密码" />
						<input type="text" name="validation" id="validation" value="" placeholder="请在此输入正确的答案" autocomplete="off" />
						<img src="/Home/User/img_code" id="change_img" alt="" class="validation" >
...
<script>
	$('#change_img').click(function(){
		$(this).attr('src','/Home/User/img_code?id='+Math.random());
	})
