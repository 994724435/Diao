...
<body>
  ...
  <!--focus end-->
    ...
    <div class="content"> 
          <div class="nPLeft fl">
                  <div class="lList bor">
                        <h3 class="leH2"><img src="/Public/Home/images/ico01.png">联系我们/ <span>LINK</span></h3>
                        <ul class="li1">
                            <li><a href="<?php echo U('/Home/About/contact');?>" class="onfucus">联系我们</a></li>
                            <li><a href="<?php echo U('/Home/Article/message');?>">客户留言</a></li>
                        </ul>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
                <div class="nplace">
                      <span class="fontRed">您当前位置：</span> <a href="#">首页</a> >> <a href="#">联系我们</a> >> 联系我们
                </div>


                <div class="link">
                    <div class="linMes fl">
                        <h3>广州八军建筑安装有限公司<br>http://www.dwjda.com.cn</h3>
                        <p><span class="fontRed">联系人：</span>黄明勇</p>
                        <p><span class="fontRed">手 机：</span>13602278279、13928744499</p>
                        <p><span class="fontRed">电 话：</span>020-31126558</p>
                        <p><span class="fontRed">邮 箱：</span>965066011@qq.com</p>
                        <p><span class="fontRed">网 址：</span>http://www.dwjda.com.cn</p>
                        <p><span class="fontRed">地 址：</span>广州番禺区桥南街南城路金奥街77号</p>
                    </div>
