...
<body>
    <div class="top">
          <div class="logo"><a href="index.htm"><img src="/Public/Home/images/logo.png" alt="广州八军建筑安装有限公司" title="广州八军建筑安装有限公司"></a></div>
    </div>
  ...
  <!--focus end-->
    ...
    <div class="content"> 
          <div class="nPLeft fl">
                  <div class="lList bor">
                        <h3 class="leH2"><img src="/Public/Home/images/ico01.png">人才招聘/ <span>JOB</span></h3>
                        <ul class="li1">
                            <li><a href="#" class="onfucus">人才招聘</a></li>
                            <li><a href="#">联系我们</a></li>
                        </ul>
                  ...
                  <div class="lList bor">
                        <h3 class="leH2"><img src="/Public/Home/images/ico02.png"> 行业资讯</h3>
                        <ul class="li2">
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂料对的... </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂...       </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂东...     </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂...       </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂东...     </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂东是额... </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂...       </a></li>
                            <li><a href="#"><span>2014-02-25</span>·公室装修的涂东是额... </a></li>
                        </ul>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
                <div class="nplace">
                      <span class="fontRed">您当前位置：</span> <a href="#">首页</a> >> <a href="#">人才招聘</a> >> 招聘列表
                </div>

                <?php if(is_array($rec)): foreach($rec as $key=>$val): ?><div class="job">
                      
                      <h4 class="jobName">招聘岗位：<?php echo ($val["recruit_name"]); ?></h4>

                      <table class="tabJob">
                            <tr>
                                <td>学历要求：<?php echo ($val["recruit_education"]); ?></td>
                                <td>工作经验：<?php echo ($val["recruit_experience"]); ?></td>
                                <td>性别：<?php echo ($val["recruit_sex"]); ?></td>                                            
                            </tr>
                            <tr>
                                <td>招聘人数：<?php echo ($val["recruit_num"]); ?></td>
                                <td>工作区：<?php echo ($val["recruit_area"]); ?></td>
                                <td>人才类型：<?php echo ($val["recruit_type"]); ?></td>                                            
                            </tr>   
                            <tr>
                                <td>职位类别：<?php echo ($val["recruit_category"]); ?></td>
                                <td>职位月薪：<?php echo ($val["recruit_salary"]); ?></td>
                                <td>职位性质：<?php echo ($val["recruit_nature"]); ?></td>                                            
                            </tr>

                            <tr>
                                <td colspan="3" class="gt">

                                    <?php echo ($val["recruit_depict"]); ?>

                                </td>                                            
                            </tr>     

                            <tr>
                                <td colspan="3" class="et">
