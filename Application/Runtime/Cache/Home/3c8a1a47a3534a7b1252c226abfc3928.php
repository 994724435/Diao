    ...
    <div class="content"> 
          <div class="nPLeft fl">
                  <div class="lList bor">
                        ...
                        <ul class="li1">
                            <li><a href="#" class="onfucus">公司新闻</a></li>
                            <li><a href="#">行业新闻</a></li>
                        </ul>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
                ...
                <div class="newsIn">
                     <h4 class="nesTitle"><?php echo ($new["art_title"]); ?></h4>
                     <h5 class="newAb">新闻分类：<?php echo ($new["cate_name"]); ?>   作者：<?php echo ($new["art_author"]); ?>   发布于：<?php echo (date("Y-m-d",$new["art_addtime"])); ?></h5>
                     <img src="<?php echo ($new["art_thumb"]); ?>" alt="">
                     <div class="newsTest">
                          <?php echo html_entity_decode($new['art_content']); ?>
                      </div>
                      <p class="newsNext"><a href="#">上一篇： 艾斯顿作品版权声明</a></p>
                      <p class="newsNext"><a href="#">上一篇： 艾斯顿作品版权声明</a></p>
