...
<html>
	...
	<body>
		...
		<div class="center-block">
		    ...
		    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><a href="" class="cl">
					<div class="left fl" style="background-image:url(<?php echo ($vo['pro_thumb']); ?>);background-repeat: no-repeat;"></div>
					<div class="right fl">
						<p class="ch_title"><?php echo ($vo['pro_name']); ?></p>
						<p class="en_title">课 程 简 介</p>
						<div class="line"></div>
						<p class="content"><?php echo ($vo['pro_introduction']); ?></p>
					</div>
